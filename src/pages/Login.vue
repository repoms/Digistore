	...
	<BaseLayout>
		<div class="hero min-h-screen">
			<div class="hero-content w-full">
				<div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 mt-[-110px]">
					<div class="card-body">
						<div class="form-control">
							<label class="label">
								<span class="text-base font-semibold label-text">Username</span>
							</label>
							<input v-model="username" type="text" placeholder="Username" class="text-sm input input-bordered" />
						</div>
						<div class="form-control">
							<label class="label">
								<span class="text-base font-semibold label-text">Password</span>
							</label>
							<input v-model="password" type="text" placeholder="Password" class="text-sm input input-bordered" />
							<label class="label">
