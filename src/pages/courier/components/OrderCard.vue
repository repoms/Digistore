    ...
    <div class="indicator w-full">
        ...
        <div class="card card-compact shadow-lg border">
            ...
            <div class="card-body flex-row justify-between">
                ...
                <div class="dropdown dropdown-end w-full text-end" v-if="IsCanChange">
...
export default {
    ...
    computed: {
        ...
        GetAllStatus() {
            let filtered = []
            utils.StatusCode.forEach((e, i) => {
                if (this.statusCode.includes(i)) filtered.push(e)
            });
            return filtered
        },
        IsCanChange() {
            return this.statusCanChange.includes(this.GetStatus.statusCode)
        }
    },
    methods: {
